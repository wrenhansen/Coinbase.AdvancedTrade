...
namespace Coinbase.AdvancedTrade.Interfaces
{
    ...
    public interface IOrdersManager
    {
        ...
        /// <summary>
        /// Asynchronously creates a market order using a provided client order ID (client_order_id).
        /// </summary>
        Task<string> CreateMarketOrderWithClientOrderIdAsync(string productId, OrderSide side, string amount, string clientOrderId);

        /// <summary>
        /// Asynchronously creates a market order using a provided client order ID (client_order_id)
        /// and returns the full order details.
        /// </summary>
        Task<Order> CreateMarketOrderWithClientOrderIdAsync(string productId, OrderSide side, string amount, string clientOrderId, bool returnOrder);

        /// <summary>
        /// Asynchronously creates a GTC limit order using a provided client order ID (client_order_id).
        /// </summary>
        Task<string> CreateLimitOrderGTCWithClientOrderIdAsync(string productId, OrderSide side, string baseSize, string limitPrice, bool postOnly, string clientOrderId);

        /// <summary>
        /// Asynchronously creates a GTC limit order using a provided client order ID (client_order_id)
        /// and returns the full order details.
        /// </summary>
        Task<Order> CreateLimitOrderGTCWithClientOrderIdAsync(string productId, OrderSide side, string baseSize, string limitPrice, bool postOnly, string clientOrderId, bool returnOrder);

        /// <summary>
        /// Asynchronously creates a GTD limit order using a provided client order ID (client_order_id).
        /// </summary>
        Task<string> CreateLimitOrderGTDWithClientOrderIdAsync(string productId, OrderSide side, string baseSize, string limitPrice, DateTime endTime, bool postOnly, string clientOrderId);

        /// <summary>
        /// Asynchronously creates a GTD limit order using a provided client order ID (client_order_id)
        /// and returns the full order details.
        /// </summary>
        Task<Order> CreateLimitOrderGTDWithClientOrderIdAsync(string productId, OrderSide side, string baseSize, string limitPrice, DateTime endTime, bool postOnly, string clientOrderId, bool returnOrder);

        /// <summary>
        /// Asynchronously creates a GTC stop limit order using a provided client order ID (client_order_id).
        /// </summary>
        Task<string> CreateStopLimitOrderGTCWithClientOrderIdAsync(string productId, OrderSide side, string baseSize, string limitPrice, string stopPrice, string clientOrderId);

        /// <summary>
        /// Asynchronously creates a GTC stop limit order using a provided client order ID (client_order_id)
        /// and returns the full order details.
        /// </summary>
        Task<Order> CreateStopLimitOrderGTCWithClientOrderIdAsync(string productId, OrderSide side, string baseSize, string limitPrice, string stopPrice, string clientOrderId, bool returnOrder);

        /// <summary>
        /// Asynchronously creates a GTD stop limit order using a provided client order ID (client_order_id).
        /// </summary>
        Task<string> CreateStopLimitOrderGTDWithClientOrderIdAsync(string productId, OrderSide side, string baseSize, string limitPrice, string stopPrice, DateTime endTime, string clientOrderId);

        /// <summary>
        /// Asynchronously creates a GTD stop limit order using a provided client order ID (client_order_id)
        /// and returns the full order details.
        /// </summary>
        Task<Order> CreateStopLimitOrderGTDWithClientOrderIdAsync(string productId, OrderSide side, string baseSize, string limitPrice, string stopPrice, DateTime endTime, string clientOrderId, bool returnOrder);

        /// <summary>
        /// Asynchronously creates a SOR limit IOC order using a provided client order ID (client_order_id).
        /// </summary>
        Task<string> CreateSORLimitIOCWithClientOrderIdAsync(string productId, OrderSide side, string baseSize, string limitPrice, string clientOrderId);

        /// <summary>
        /// Asynchronously creates a SOR limit IOC order using a provided client order ID (client_order_id)
        /// and returns the full order details.
        /// </summary>
        Task<Order> CreateSORLimitIOCWithClientOrderIdAsync(string productId, OrderSide side, string baseSize, string limitPrice, string clientOrderId, bool returnOrder);
